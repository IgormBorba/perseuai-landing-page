    ...
    return (
        <Section id="how-to-use">
            <div className="container">
                <Heading title="Eleve o Nível da sua Empresa" text="Na Perseu.AI, acreditamos que a inovação não é apenas uma tendência, mas uma jornada rumo à perfeição." />
                ...
                <div className="relative">
                    <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-white/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                        ...
                        <div className="relative z-1 max-w-[17rem] ml-auto">
                            <h4 className="h4 mb-4">Chatbot Inteligente</h4>
                            <p className="body-2 mb-[3rem] text-n-3">Chatbots com IA avançada para atendimento personalizado e eficiente</p>
                            <ul className="body-2">
                                <li className="flex items-start py-4 border-t border-n-6">
                                    <img width={24} height={24} src={check} />
                                    <p className="ml-4">Processamento de linguagem natural</p>
                                </li>
                                <li className="flex items-start py-4 border-t border-n-6">
                                    <img width={24} height={24} src={check} />
                                    <p className="ml-4">Respostas personalizadas</p>
                                </li>
                                <li className="flex items-start py-4 border-t border-n-6">
                                    <img width={24} height={24} src={check} />
                                    <p className="ml-4">Integração multicanal</p>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="relative z-1 grid gap-5 lg:grid-cols-2">
                        <div className="relative min-h-[39rem] border border-white/10 rounded-3xl overflow-hidden">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                                <h4 className="h4 mb-4">Gestão Inteligente</h4>
                                <p className="body-2 mb-[3rem] text-n-3">Automatize suas operações e melhore a eficiência do seu atendimento com nossa IA</p>
                            </div>
                        ...
                        <div className="p-4 bg-[#15131D] rounded-3xl overflow-hidden lg:min-h-[46rem]">
                            <div className="py-12 px-4 xl:px-8">
                                <h4 className="h4 mb-4">Análise de Dados</h4>
                                <p className="body-2 mb-[2rem] text-n-3">Transforme dados em insights acionáveis para melhorar seu atendimento</p>
